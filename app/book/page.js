        ...
        <div className="max-[340px]:h-[90vh] max-sm:h-[60vh] md:h-[70vh] flex items-center justify-center w-full">
            ...
            <div className='absolute max-md:mt-10 w-full flex flex-col gap-5 justify-center text-white px-6 lg:px-20'>
              <div className="w-full flex flex-col gap-5 justify-center text-white">
                <h1 className='text-3xl lg:text-5xl font-semibold w-full lg:w-[55%] leading-tight' data-aos="slide-right" data-aos-delay="100">Book a Minister for your Event</h1>
                <p className='lg:w-[57%]' data-aos="slide-right" data-aos-delay="300">Invite a member of our team to speak, lead worship, or minister at your next program.</p>
              </div>
            </div>
        </div>
        ...
        <div className='grid grid-cols-1 items-center gap-10 px-6 lg:px-20 py-16'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-5 py-4'>
                    {expect.map((item, id) => {
                        return(
                            <div key={id} className='flex items-center gap-4' data-aos="slide-right">
